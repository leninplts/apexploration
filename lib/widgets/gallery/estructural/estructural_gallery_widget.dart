...
class EstructuralGalleryWidget extends StatefulWidget {
  @override
  _EstructuralGalleryWidgetState createState() => _EstructuralGalleryWidgetState();
}

class _EstructuralGalleryWidgetState extends State<EstructuralGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Estructural",
      showGoBack: true,
