...
class EstimadorGalleryWidget extends StatefulWidget {
  @override
  _EstimadorGalleryWidgetState createState() => _EstimadorGalleryWidgetState();
}

class _EstimadorGalleryWidgetState extends State<EstimadorGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Estimador",
      showGoBack: true,
