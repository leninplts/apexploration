...
class MinerologiaGalleryWidget extends StatefulWidget {
  @override
  _MinerologiaGalleryWidgetState createState() => _MinerologiaGalleryWidgetState();
}

class _MinerologiaGalleryWidgetState extends State<MinerologiaGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Resumen Silicatos",
      showGoBack: true,
