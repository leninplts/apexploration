...
class VectorizarGalleryWidget extends StatefulWidget {
  @override
  _VectorizarGalleryWidgetState createState() => _VectorizarGalleryWidgetState();
}

class _VectorizarGalleryWidgetState extends State<VectorizarGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Vectorizar",
      showGoBack: true,
