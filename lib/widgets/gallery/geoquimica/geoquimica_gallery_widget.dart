...
class GeoquimicaGalleryWidget extends StatefulWidget {
  @override
  _GeoquimicaGalleryWidgetState createState() => _GeoquimicaGalleryWidgetState();
}

class _GeoquimicaGalleryWidgetState extends State<GeoquimicaGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Geoquimica",
      showGoBack: true,
