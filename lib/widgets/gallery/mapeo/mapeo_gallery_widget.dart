...
class MapeoGalleryWidget extends StatefulWidget {
  @override
  _MapeoGalleryWidgetState createState() => _MapeoGalleryWidgetState();
}

class _MapeoGalleryWidgetState extends State<MapeoGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Mapeo",
      showGoBack: true,
