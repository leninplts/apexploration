...
class PetrologiaGalleryWidget extends StatefulWidget {
  @override
  _PetrologiaGalleryWidgetState createState() => _PetrologiaGalleryWidgetState();
}

class _PetrologiaGalleryWidgetState extends State<PetrologiaGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Flujograma para campo",
      showGoBack: true,
