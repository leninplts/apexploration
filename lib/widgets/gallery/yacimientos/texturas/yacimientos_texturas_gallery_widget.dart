...
class YacimientosTexturasGalleryWidget extends StatefulWidget {
  @override
  _YacimientosTexturasGalleryWidgetState createState() => _YacimientosTexturasGalleryWidgetState();
}

class _YacimientosTexturasGalleryWidgetState extends State<YacimientosTexturasGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Texturas en Vetas",
      showGoBack: true,
            ...
            Container(
              child: GridView.count(
                  ...
                  children: [
                    ...
                    Container(
                      child: GalleryExampleItemThumbnail(
                        galleryExampleItem: galleryItems[16],
                        onTap: () {
                          open(context, 16);
                        },
                      ),
