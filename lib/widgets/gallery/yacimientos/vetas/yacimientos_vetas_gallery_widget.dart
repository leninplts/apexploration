...
class YacimientosVetasGalleryWidget extends StatefulWidget {
  @override
  _YacimientosVetasGalleryWidgetState createState() => _YacimientosVetasGalleryWidgetState();
}

class _YacimientosVetasGalleryWidgetState extends State<YacimientosVetasGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Como describir vetas",
      showGoBack: true,
