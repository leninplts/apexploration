...
class BrechasGalleryWidget extends StatefulWidget {
  @override
  _BrechasGalleryWidgetState createState() => _BrechasGalleryWidgetState();
}

class _BrechasGalleryWidgetState extends State<BrechasGalleryWidget> {

  @override
  Widget build(BuildContext context) {
    return ExampleAppBarLayout(
      title: "Imagenes Brechas",
      showGoBack: true,
